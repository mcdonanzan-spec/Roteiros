  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <header className="mb-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-slate-500 text-sm flex items-center gap-2">
            <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-indigo-100 text-indigo-700 uppercase">Gestão Mensal de Visitas</span>
          </p>
        </div>
        ...
        <main className="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="space-y-6">
            ...
            <section className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
              ...
              <textarea
                ...
                placeholder="Cole aqui (Razão Social	Nome Obra	Endereço...)"
            ...
            >
              ...
              {loading ? 'Distribuindo visitas no mês...' : 'Gerar Planejamento Mensal Completo'}
            </button>
          </div>
          ...
          <div className="hidden lg:flex flex-col justify-center items-center p-12 bg-slate-100 rounded-3xl border border-slate-200 border-dashed">
             <div className="text-center space-y-3">
               ...
               <h3 className="text-lg font-bold text-slate-800">Carga Horária Inteligente</h3>
               <p className="text-slate-500 text-sm max-w-xs mx-auto italic">
                 "Distribuímos todas as obras da sua planilha ao longo de 4 semanas, respeitando o tempo de deslocamento por trilhos."
               </p>
             </div>
          </div>
        </main>
        ...
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
          <section className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bg-indigo-600 p-6 rounded-2xl shadow-lg shadow-indigo-100 text-white text-center">
               <span className="text-xs font-bold text-indigo-200 uppercase">Horas Economizadas</span>
          ...
          <section>
            <div className="flex items-center justify-between mb-8">
               <h2 className="text-2xl font-black text-slate-800 flex items-center gap-3">
                 ...
                 Padrão de Roteiro (Semana 1)
               </h2>
               <span className="text-sm font-medium text-slate-400">Detalhamento de Linhas e Tempos</span>
            </div>
          ...
          {/* The Actual Monthly Agenda - FIXING THE EMPTY DATA ISSUE */}
          <section className="bg-white p-10 rounded-[40px] border border-slate-100 shadow-sm">
             <div className="mb-10">
                <h3 className="text-2xl font-black text-slate-800">Calendário Mensal de Obras</h3>
                <p className="text-sm text-slate-400 mt-1">Todas as obras da sua planilha distribuídas estrategicamente.</p>
             </div>
          ...
          <section className="bg-indigo-900 rounded-[40px] p-10 text-white flex flex-col lg:flex-row gap-10 items-center">
             <div className="flex-1 space-y-6">
                ...
                <div className="flex flex-wrap gap-3">
                   {result.housingRecommendation.topNeighborhoods.map(b => (
                     <span key={b} className="px-5 py-3 bg-white/10 rounded-2xl font-bold border border-white/10 hover:bg-white/20 transition-all">{b}</span>
                   ))}
                </div>
             ...
             <div className="w-full lg:w-80 bg-white/5 rounded-3xl p-8 border border-white/10 backdrop-blur">
                <div className="space-y-6">
                  <div>
                    <span className="block text-[10px] font-black text-indigo-300 uppercase mb-1">Média Mensal Otimizada</span>
                  ...
                  <div className="pt-6 border-t border-white/10 text-xs text-indigo-200 italic">
                    Economia total estimada de {result.housingRecommendation.comparison.monthlySavings} por mês em deslocamento.
                  </div>
                </div>
             </div>
          </section>
          ...
          <section className="bg-emerald-50 border-2 border-emerald-100 p-10 rounded-[40px] text-center max-w-4xl mx-auto">
             <h3 className="text-xl font-black text-emerald-800 mb-4 uppercase tracking-wider">Conclusão Logística</h3>
      ...
      <footer className="mt-20 py-10 border-t border-slate-100 text-center">
         <p className="text-[10px] font-bold text-slate-300 uppercase tracking-widest">SP Route Optimizer Agent • 2025 • Engenharia de Mobilidade</p>
      </footer>
    </div>
  );
};
